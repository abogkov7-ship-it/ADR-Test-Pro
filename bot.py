...
def main_menu():
    ...
    kb.add(
        types.InlineKeyboardButton("📚 Тренировка", callback_data="start_training"),
...
def send_question(chat_id):
    ...
    title = f"🚛 ADR • Вопрос {q.get('number', '')}"
...
print(f"ADR bot started. Loaded {len(QUESTIONS)} questions.")
